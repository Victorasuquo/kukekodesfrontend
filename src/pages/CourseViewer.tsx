...
import { AITutor } from '@/components/sections/AICoach';
...
export default function CourseViewer() {
  ...
  return <div className="min-h-screen bg-background"><Navbar /><main className="container mx-auto px-4 py-8 pt-24">
    ...
    <div className="grid gap-8 lg:grid-cols-3"><div className="space-y-5 lg:col-span-2">
      ...
      {enrolled && activeLesson && <><Card><CardHeader><CardTitle>AI Coach</CardTitle><CardDescription>Ask about this lesson using bounded course context.</CardDescription></CardHeader><CardContent><AITutor lessonId={activeLesson.id} /></CardContent></Card>{activeLesson.exercise_runtime && <Card><CardHeader><CardTitle>Practice exercise</CardTitle><CardDescription>Run only the runtime supported by this exercise.</CardDescription></CardHeader><CardContent><CodeEditor lessonId={activeLesson.id} runtime={activeLesson.exercise_runtime} /></CardContent></Card>}</>}
